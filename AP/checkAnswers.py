def main():
	...
	answersFileName = input("File with your answers: ")
	keyFileName = input("File with answer key: ")

	myAnswersFile = open(answersFileName, 'r')
	...
	correctAnswersFile = open(keyFileName, 'r')
